...
function App({ htmlContent, onChange }: { htmlContent?: string, onChange?: (html: string) => void }): JSX.Element {
  const {
    settings: {
      isCollab,
      useCollabV2,
    ...
    <LexicalCollaboration>
      <LexicalExtensionComposer extension={app} contentEditable={null}>
        <ToolbarContext>
          ...
          <HtmlPlugin initialHtml={htmlContent || ''} onChange={onChange || (() => {})} />
        </ToolbarContext>
...
export default function AppWrapper(props: { htmlContent?: string, onChange?: (html: string) => void }): JSX.Element {
  return (
    <SettingsContext>
      <FlashMessageContext>
        <App htmlContent={props.htmlContent} onChange={props.onChange} />
      </FlashMessageContext>
