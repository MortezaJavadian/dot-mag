...
export function PersonProfileBlock({
  ...
  return (
    <div
      className={`w-fit max-w-full rounded-2xl border border-card-border bg-card-bg px-3 py-2.5 md:px-4 md:py-3 shadow-[0_10px_24px_rgba(0,0,0,0.08)] dark:shadow-[0_14px_28px_rgba(0,0,0,0.16)] ${className || ""}`}
    >
